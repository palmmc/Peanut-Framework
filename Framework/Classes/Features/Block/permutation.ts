...
import { toJSON } from "../../../Utilities/utils";
...
export class Permutation {
  private expression: Molang | string;
  ...
  public condition(expression: Molang | string) {
    this.expression = expression;
    return this;
  }
  public compile() {
    if (this.expression instanceof Molang)
      this.expression = this.expression.expression.trim();
    const data = {
